...
package com.chaplin.realtimevoicetranslation.voice_translation._conversation_mode.communication;
...
public class ConversationBluetoothCommunicator {
    ...
    public synchronized boolean isBluetoothLeSupported() {
        if (bluetoothCommunicator.isBluetoothLeSupported() == BluetoothCommunicator.BLUETOOTH_LE_NOT_SUPPORTED) {
            return false;
        } else {
            return true;
        }
