...
import com.chaplin.realtimevoicetranslation.tools.FileLog;
import com.chaplin.realtimevoicetranslation.tools.Tools;
import com.chaplin.realtimevoicetranslation.tools.gui.RequestDialog;
...
import com.chaplin.realtimevoicetranslation.tools.gui.peers.PeerListAdapter;
import com.chaplin.realtimevoicetranslation.tools.gui.peers.array.PairingArray;
...
import com.chaplin.realtimevoicetranslation.voice_translation._conversation_mode.communication.recent_peer.RecentPeersDataManager;
...
public class PairingFragment extends PairingToolbarFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        firebaseButton = view.findViewById(R.id.button);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        firebaseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                activity.setFragment(VoiceTranslationActivity.FIREBASE_ROOM_FRAGMENT);
            }
        });
    }
