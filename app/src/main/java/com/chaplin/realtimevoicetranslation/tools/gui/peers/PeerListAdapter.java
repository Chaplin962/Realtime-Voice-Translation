...
import com.chaplin.realtimevoicetranslation.tools.gui.peers.array.PeerListArray;
...
public class PeerListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        drawable.setShape(GradientDrawable.OVAL); // Set shape to circle
        drawable.setColor(Color.parseColor("#0FE16D")); // Set color
        drawable.setSize(8, 8); // Set size to match view
        if (itemType == HEADER) {
            ...
            if (recentPeer.isAvailable()) {
                ...
                drawable.setColor(Color.parseColor("#0FE16D"));

                ((View) view.findViewById(R.id.online_status)).setBackground(drawable);
            } else {
                ((TextView) view.findViewById(R.id.path)).setText(R.string.not_available);
                drawable.setColor(Color.parseColor("#9A9E9C"));
