...
package com.chaplin.realtimevoicetranslation.tools.gui.animations;
...
import com.chaplin.realtimevoicetranslation.tools.gui.ButtonKeyboard;
import com.chaplin.realtimevoicetranslation.tools.gui.ButtonMic;
...
public class CustomAnimator {
    ...
    public void animateOnVoiceStart(final ButtonMic buttonMic) {
        ...
        int initialColor = GuiTools.getColor(buttonMic.getContext(), R.color.accent_white);
        int initialColor2 = GuiTools.getColor(buttonMic.getContext(), R.color.green);
        int finalColor = GuiTools.getColor(buttonMic.getContext(), R.color.red);
        Animator animatorColor = createAnimatorColor(buttonMic.getDrawable(), initialColor, finalColor, duration);
        Animator animatorColor2 = createAnimatorColor(buttonMic.getDrawable(R.drawable.rectangle_1), initialColor2, finalColor, duration);
        animatorColor.start();
        animatorColor2.start();
    }
    ...
    public void animateOnVoiceEnd(final ButtonMic buttonMic) {
        ...
        // change color animation
        int initialColor = GuiTools.getColor(buttonMic.getContext(), R.color.red);
        int finalColor2 = GuiTools.getColor(buttonMic.getContext(), R.color.green);
        int finalColor = GuiTools.getColor(buttonMic.getContext(), R.color.accent_white);
        Animator animatorColor2 = createAnimatorColor(buttonMic.getDrawable(R.drawable.rectangle_1), initialColor, finalColor2, duration);
        Animator animatorColor = createAnimatorColor(buttonMic.getDrawable(), initialColor, finalColor, duration);
        animatorColor.start();
        animatorColor2.start();
    ...
    public Animator createAppearFromTopAnimator(int duration, int finalHeight, int finalMargin, final View view, final Animator.AnimatorListener animatorListener) {
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(final Animator animator) {
                ...
                view.setAlpha(0f);
                if (animatorListener != null) animatorListener.onAnimationStart(animator);
            }

            @Override
            public void onAnimationEnd(Animator animator) {
                if (animatorListener != null) animatorListener.onAnimationEnd(animator);
            }

            @Override
            public void onAnimationCancel(Animator animator) {
                if (animatorListener != null) animatorListener.onAnimationCancel(animator);
            }
    ...
    public Animator createAnimatorColor(final SwitchButton drawable, int initialColor, int finalColor, int duration, boolean background) {
        final int[][] states = new int[][]{new int[]{android.R.attr.state_checked}, // checked
