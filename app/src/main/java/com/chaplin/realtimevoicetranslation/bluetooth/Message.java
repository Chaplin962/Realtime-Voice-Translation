...
public class Message implements Parcelable, Cloneable {
     ...
     */
    public ArrayDeque<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> splitInBluetoothMessages(com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber id) {
        int subDataLength = com.chaplin.realtimevoicetranslation.bluetooth.BluetoothConnection.SUB_MESSAGES_LENGTH - com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.TOTAL_LENGTH;
        ...
        com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber sequenceNumber = new com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber(context, com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SEQUENCE_NUMBER_LENGTH);
        ArrayDeque<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> bluetoothMessages = new ArrayDeque<>();
        while (subDataArray.peekFirst() != null) {
            byte[] subData = subDataArray.pollFirst();
            int type;
            if (subDataArray.peekFirst() == null) {
                type = com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.FINAL;
            } else {
                type = com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.NON_FINAL;
            }
            bluetoothMessages.addLast(new com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage(context, id.clone(), sequenceNumber.clone(), type, subData));
