        ...
        synchronized (lock) {
            ...
            if (bluetoothGattServer != null) {
                ...
                if (service != null) {
                    ...
                    if (output != null) {
                        output.setValue(String.valueOf(com.chaplin.realtimevoicetranslation.bluetooth.BluetoothConnection.ACCEPT).getBytes(StandardCharsets.UTF_8));
        ...
        synchronized (lock) {
            ...
            if (bluetoothGattServer != null) {
                ...
                if (service != null) {
                    BluetoothGattCharacteristic output = service.getCharacteristic(BluetoothConnectionServer.CONNECTION_RESPONSE_UUID);
                    if (output != null) {
                        output.setValue(String.valueOf(com.chaplin.realtimevoicetranslation.bluetooth.BluetoothConnection.REJECT).getBytes(StandardCharsets.UTF_8));
                        sendingCharacteristic = BluetoothConnectionServer.CONNECTION_RESPONSE_UUID;
                        success = bluetoothGattServer.notifyCharacteristicChanged(getPeer().getRemoteDevice(bluetoothAdapter), output, true);
                    }
                }
