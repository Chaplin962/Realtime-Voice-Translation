...
abstract class Channel {
    ...
    @NonNull
    private Peer peer;
    private com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber messageID;
    private com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber dataID;
    @Nullable
    protected ArrayDeque<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> pendingMessage;
    @Nullable
    protected ArrayDeque<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> pendingData;
    private ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> receivingMessages = new ArrayList<>();
    private ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> receivingData = new ArrayList<>();
    private ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> receivedMessages = new ArrayList<>();
    private ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> receivedData = new ArrayList<>();
    ...
    protected Channel(Context context, @NonNull Peer peer) {
        ...
        this.messageID= new com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber(context, com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.ID_LENGTH);
        this.dataID= new com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.SequenceNumber(context, com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.ID_LENGTH);
    ...
    public void writeMessage(com.chaplin.realtimevoicetranslation.bluetooth.Message message, MessageCallback callback) {
        synchronized (lock) {
    ...
    public void onSubMessageWriteSuccess() {
        synchronized (lock) {
            com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage subMessageSent = null;
            if (pendingMessage != null) {
                subMessageSent = pendingMessage.pollFirst();  // remove the newly sent subMessage
            }
            resetMessageTimer();
            if (subMessageSent != null && subMessageSent.getType() == com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.FINAL) {
    ...
    public void onSubDataWriteSuccess() {
        synchronized (lock) {
            com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage subDataSent = null;
            if (pendingData != null) {
                subDataSent = pendingData.pollFirst();  // remove the newly sent subMessage
            }
            resetDataTimer();
            if (subDataSent != null && subDataSent.getType() == com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage.FINAL) {
    ...
    @Nullable
    public com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage getPendingSubMessage() {
        synchronized (lock) {
            if (pendingMessage != null) {
    ...
    @Nullable
    public com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage getPendingSubData() {
        synchronized (lock) {
            if (pendingData != null) {
    ...
    public ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> getReceivingMessages() {
        return receivingMessages;
    }

    public ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> getReceivingData() {
        return receivingData;
    }

    public ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> getReceivedMessages() {
        return receivedMessages;
    }

    public ArrayList<com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage> getReceivedData() {
        return receivedData;
    }

    public void addReceivedMessage(com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage message) {
    ...
    public void addReceivedData(com.chaplin.realtimevoicetranslation.bluetooth.BluetoothMessage data) {
        if(data.getId().isMax()){
            receivedData.clear();
        }else{
