    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        userImagePreference.setLifecycleListener(new UserImagePreference.LifecycleListener() {
            ...
            public void onBindViewHolder() {
                userImageContainer = new GalleryImageSelector(userImagePreference.getImage(), activity, SettingsFragment.this, R.drawable.user_icon, "com.gallery.RealtimeVoiceTranslator.1.0.provider");
            }
        });
